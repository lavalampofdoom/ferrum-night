...
const HELP: SearchHit[] = [
  ...
  },
  {
    ...
    blurb: "Press E (or the hand) on a door, cabinet, bed, crate, lock, car, or workbench. Searching a crate opens it — take what you want, leave the rest, or store your own.",
    href: "/guide?q=search",
  ...
  },
  {
    ...
    kind: "help",
    title: "Attack — Space",
    blurb: "Space or click swings and fires toward the mouse on a computer. Melee only connects up close. Guns need matching ammo. Paintball stuns; jam it into them at contact to hurt.",
    href: "/guide?q=attack",
  ...
  },
  {
    ...
    kind: "help",
    title: "Interiors",
    blurb: "Houses are rooms off a short hall — beds, shelves, crates. You cannot see through walls. Ferrum College halls open into classrooms and dorms. Lowe's is aisles.",
  ...
  },
  {
    ...
    kind: "help",
    title: "Pack — I",
    blurb: "Open the pack to eat, drink, wear armor, craft, or drop items on the ground. Hand recipes are simple. A placed workbench unlocks metal, ammo, and meds.",
    href: "/guide?q=pack",
